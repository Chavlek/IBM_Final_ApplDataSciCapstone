...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        names= counts.index, 
        title='Launch Site CCAFS LC-40 Success')
        return fig
        ...
        fig = px.pie(values=counts,  
        names= counts.index, 
        title='Launch Site VAFB SLC-4E Success')
        return fig
        ...
        fig = px.pie(values=counts, 
        names= counts.index, 
        title='Launch Site KSC LC-39A Success')
        return fig
    else:
        ...
        fig = px.pie( values=counts, 
        names= counts.index,
        title='Launch Site CCAFS SLC-40 Success')
        return fig
